  ...
  <thead>
              <th colspan="2"><center>Test</center></th>
                ...
                <tr>
                  ...
                  <th class="two wide"><center>Sign-off</center></th>
                </tr>
...
<tbody>
  ...
  <td>
    <div class="ui form">
      <input type="text" id="f/m/u" placeholder="F | M | U"/>
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.22" name="ISCV_IBE_Parsing.${TableCtr}.22" />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.31" name="ISCV_IBE_Parsing.${TableCtr}.31" placeholder="  ISCV Study Config 4" />
    </div>
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.32" name="ISCV_IBE_Parsing.${TableCtr}.32" placeholder="O| I | E" />
    </div>
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.33" name="ISCV_IBE_Parsing.${TableCtr}.33" />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.37" name="ISCV_IBE_Parsing.${TableCtr}.37" placeholder="RE" />
    </div>
  ...
  <td><div class="ui form">
    <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.38" name="ISCV_IBE_Parsing.${TableCtr}.38" placeholder="ISCV Study ID"  />
  </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.39" name="ISCV_IBE_Parsing.${TableCtr}.39"  />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.41" name="ISCV_IBE_Parsing.${TableCtr}.41" placeholder="HIS Order ID" />
    </div>
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.42" name="ISCV_IBE_Parsing.${TableCtr}.42" placeholder="ISCV Study ID" />
    </div>
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.43" name="ISCV_IBE_Parsing.${TableCtr}.43" />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.52" name="ISCV_IBE_Parsing.${TableCtr}.52" placeholder="CUS" />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.53" name="ISCV_IBE_Parsing.${TableCtr}.53" placeholder="  P | F | C | R | D" />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.54" name="ISCV_IBE_Parsing.${TableCtr}.54"  />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.61" name="ISCV_IBE_Parsing.${TableCtr}.61" placeholder="TX" />
    </div>
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.62" name="ISCV_IBE_Parsing.${TableCtr}.62" placeholder="ISCV Study ID" />
    </div>
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.63" name="ISCV_IBE_Parsing.${TableCtr}.63" />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="ISCV_IBE_Parsing.${TableCtr}.66" name="ISCV_IBE_Parsing.${TableCtr}.66" placeholder="P | F | C | R | D" />
    </div>
  </td>
  <td>
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="Expected_Value.${TableCtr}.71" name="Expected_Value.${TableCtr}.71" />
    </div>
  </td>
  <td colspan="2">
    <div class="ui form">
  ...
  <td>
    <div class="ui form">
      <input type="text" id="Expected_Value.${TableCtr}.72" name="Expected_Value.${TableCtr}.72" />
    </div>
  </td>
  <td colspan="2">
    <div class="ui form">
  ...
  `
	...
	$('#results_utrTable').append(rowString);
